...
- (nonnull instancetype)initWithPreviewView:(UIView * _Nonnull)previewView threshold:(enum LivenessUtilitySensitivityThreshold)threshold delay:(double)delay smallFaceThreshold:(double)smallFaceThreshold debugging:(BOOL)debugging transactionId:(NSString * _Nonnull)transactionId OBJC_DESIGNATED_INITIALIZER;
...
- (void)calculateLivenessWithTransactionId:(NSString * _Nonnull)transactionId frame:(ARFrame * _Nonnull)frame onDone:(void (^ _Nullable)(BOOL, float, float, BOOL, NSString * _Nonnull, UIImage * _Nonnull))onDone;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC15LivenessUtility16LivenessResponse")
...
SWIFT_CLASS("_TtC15LivenessUtility14LivenessResult")
...
+ (LivenessUtilityDetector * _Nonnull)createLivenessDetectorWithPreviewView:(UIView * _Nonnull)previewView threshold:(enum LivenessUtilitySensitivityThreshold)threshold delay:(double)delay smallFaceThreshold:(double)smallFaceThreshold debugging:(BOOL)debugging delegate:(id <LivenessUtilityDetectorDelegate> _Nullable)delegate livenessMode:(enum LivenessMode)livenessMode additionParam:(NSDictionary<NSString *, id> * _Nonnull)additionParam additionHeader:(NSDictionary<NSString *, NSString *> * _Nonnull)additionHeader SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
- (void)livenessWithLiveness:(LivenessUtilityDetector * _Nonnull)liveness didFinish:(UIImage * _Nonnull)verificationImage livenesScore:(float)livenesScore faceMatchingScore:(float)faceMatchingScore result:(BOOL)result message:(NSString * _Nonnull)message videoURL:(NSURL * _Nullable)videoURL;
@end
...
SWIFT_CLASS("_TtC15LivenessUtility10Networking") SWIFT_AVAILABILITY(ios,introduced=13.0)
...
- (LivenessResponse * _Nonnull)generateDeviceInforWithAdditionParam:(NSDictionary<NSString *, id> * _Nonnull)additionParam paramHeader:(NSDictionary<NSString *, NSString *> * _Nonnull)paramHeader ownerId:(NSString * _Nonnull)ownerId SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_AVAILABILITY(ios,introduced=13.0)
@interface Networking (SWIFT_EXTENSION(LivenessUtility))
