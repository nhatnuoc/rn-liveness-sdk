package com.livenessrnexample.mlkit.text;
...
import com.livenessrnexample.mlkit.BitmapUtils;
import com.livenessrnexample.mlkit.DocType;
import com.livenessrnexample.mlkit.camera.FrameMetadata;
...
public class TextRecognitionProcessor {
    ...
    public void process(ByteBuffer data, FrameMetadata frameMetadata, GraphicOverlay graphicOverlay) throws MlKitException {
        ...
        String b64Image = BitmapUtils.getBase64Image(data, frameMetadata);
        ...
        detectInVisionImage(inputImage, frameMetadata, graphicOverlay, b64Image);
    }
    ...
    protected void onSuccess(@NonNull Text results, @NonNull FrameMetadata frameMetadata, @NonNull GraphicOverlay graphicOverlay, @NonNull String b64Image) {
        ...
        for (int i = 0; i < blocks.size(); i++) {
            ...
            for (int j = 0; j < lines.size(); j++) {
                ...
                for (int k = 0; k < elements.size(); k++) {
                    filterScannedText(graphicOverlay, elements.get(k), b64Image);
                }
            }
        }
    }

    private void filterScannedText(GraphicOverlay graphicOverlay, Text.Element element, String b64Image) {
...
//                String line = matcherIDCardTD1Line3.group(0);
                if (line1.startsWith("ID")) {
                    ...
                    if (mrzInfo != null)
                        finishScanning(mrzInfo, b64Image);
                }
            }
    ...
    private void detectInVisionImage(InputImage image, final FrameMetadata metadata, final GraphicOverlay graphicOverlay, final String b64Image) {
                ...
                .addOnSuccessListener(
                        new OnSuccessListener<Text>() {
                            ...
                            public void onSuccess(Text results) {
                                ...
                                TextRecognitionProcessor.this.onSuccess(results, metadata, graphicOverlay, b64Image);
                            }
                        })
    ...
    private void finishScanning(final MRZInfo mrzInfo, String b64Image) {
        try {
            if(isMrzValid(mrzInfo)) {
                ...
                new Handler().postDelayed(() -> resultListener.onSuccess(mrzInfo, b64Image), 1000);
            }
    ...
    public interface ResultListener {
        void onSuccess(MRZInfo mrzInfo, String b64Data);
