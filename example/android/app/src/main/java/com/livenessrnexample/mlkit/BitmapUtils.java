...
public class BitmapUtils {
	...
	/** Converts NV21 format byte buffer to base64 image. */
	public static String getBase64Image(ByteBuffer data, FrameMetadata metadata) {
		try {
			Bitmap bm = getBitmap(data, metadata);
